...
is visibly styled and draggable; each dock keeps a minimum width so both
panels remain usable. The selected widths are part of the global dock layout
state and are restored with the workspace.
